    ...
    return (
        <div className='h-screen'>
            <div className='mx-5 flex justify-center align-middle'>
                <div className='h-auto mt-20 text-xl bg-blue-300 rounded-lg p-8'>
                    <div className='m-4'>
                        <input
                            type="text"
                        ...
                        />
                        <button
                            className='ml-2 py-2 px-4 rounded-full border-r-2 text-white'
                                ...
                                <li key={todo.id} className='flex items-center justify-between mt-4'>
                                    <div className='flex items-center'>
                                        ...
                                        <span
                                            ...
                                            style={{ minWidth: '200px', maxWidth: '70%' }} // Adjust width here
                                        >
                                            {todo.text}
                                        </span>
                                    </div>
